...
WebUI.verifyEqual(pageTitle, "Dashboard")

WebUI.click(findTestObject('Page_Dashboard/a_Log Out'))

WebUI.verifyElementInViewport(findTestObject('Page_Administator Login/form_Login Panel'), 30, FailureHandling.STOP_ON_FAILURE)
